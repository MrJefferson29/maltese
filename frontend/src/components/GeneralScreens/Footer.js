    ...
    <FooterContainer>
      <Container>
        <Row>
          <Col md={4}>
            <FooterSection>
              <FooterLogo>Maltese Puppies 4 Adoption</FooterLogo>
              <FooterDescription>
                Quality bred Maltese pupps, ready to find a place in your home, and in your heart
          ...
          <Col md={4}>
            <FooterSection>
              ...
              <br />
              <p><b>Loisiana, USA</b></p>
            </FooterSection>
          </Col>
        </Row>
      </Container>
      <FooterBottom>
        <p>&copy; 2024 Maltese puppies 4 adoption. All rights reserved.</p>
      </FooterBottom>
    </FooterContainer>
  );
}
