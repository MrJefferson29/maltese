...
import br1 from "../../Assets/angel.jpg";
import ma1 from "../../Assets/tea1.jpg";
...
const About = () => {
  return (
    <Container>
      <Header>
        <h1>Maltese & Maltipoo Excellence</h1>
      ...
      <Section>
        <Content>
          ...
          <Paragraph>
            At Maltese Excellence, we specialize in breeding and selling
            top-quality pupps to loving families. With over
            a decade of experience, we take pride in the ethical and careful
            breeding of Maltese and Maltese Poodles, ensuring that each pup is healthy,
      ...
      <Section>
        <Content>
          ...
          <Paragraph>
            At Maltese Excellence, we are highly selective about the homes we
      ...
      <Section>
        <Content>
          ...
          <Paragraph>
            ...
            well-being of every dog we breed. As dedicated Maltese lovers, we
      ...
      <Footer>
        <p>&copy; 2024 Maltese Excellence. All rights reserved.</p>
      </Footer>
    </Container>
  );
};
