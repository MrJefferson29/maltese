...
const FAQ = () => {
  return (
    <FAQContainer>
      ...
      <Paragraph>
        Bringing a Maltese pupp into your life can be a rewarding and
      ...
      <Subheading>Difference between the Breeds:</Subheading>
      <Paragraph>
        The Maltese is a purebred toy breed known for its silky white coat,
        gentle temperament, and low-energy nature, making it ideal for quiet
        households, while the Maltipoo, a cross between a Maltese and a Poodle,
        has a curly or wavy coat in various colors, a playful and energetic
        personality, and suits active families. Both are affectionate and
        trainable, though the Maltipoo tends to learn quicker and requires
        slightly more grooming and playtime. They share a lifespan of 10–15
        years, with specific health concerns varying by breed. Both make
        wonderful companions, differing mainly in energy levels and grooming
        needs.
      </Paragraph>

      <Subheading>Understanding the Breed:</Subheading>
      <Paragraph>
        Maltese & come in four standard colours: black, yellow, red, and
        chocolate. They are medium to large-sized dogs with a strong, athletic
        build. Maltese & Maltipoo are known for their friendly and outgoing
      ...
      <Paragraph>
        Maltese and Maltipoos are intelligent and energetic dogs that require mental
      ...
      <Paragraph>
        Maltese have a long, dense coat that is relatively low-maintenance.
